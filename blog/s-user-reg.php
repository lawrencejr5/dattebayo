...
if(isset($_POST['submit'])){
    ...
    if(empty($username) || empty($email) || empty($password) || empty($cpassword)){
        ...
        if($password == $cpassword){
            ...
            $select = "SELECT username FROM oga_acc WHERE username = :username";
            ...
            if($select_stmt -> rowcount() == 0){
                ...
                $sql = "INSERT INTO oga_acc( `username`, `email`, `password`) 
...
<body>
    ...
    <form action="" method="post">
        ...
        <br><br>
        <span>Already have an account <a href="s-user-login.php">Sign in</a> here</span>
        <br><br><br>
    </form>
