	...
	<div class="wrapper">
				...
				<div class="container">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">
							<h1 style="margin-left: 1rem;">User</h1>
						</a>
					</div>
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown">
								...
								<?php  
                                    ...
                                    ?>
									<li><a href="s-cat-user.php?category=<?php echo $row['cat_name']; ?>"><?php echo $cat_name ?></a></li>
                                    <?php  }?>
								</ul>
							</li>
		...
		<div class="event" id="event">
			<div class="container">
				...
				<span class="input-group-btn">
					<a href="u-moreup.php"><button class="btn btn-default" type="button">See More</button></a>
				</span>
				</center>
			</div>
			<hr>
		...
		<div class="blog" id="blog">
			<div class="container">
				...
				<?php }else{
					...
					<div class="col-md-6 col-sm-6">
						...
						<div class="entry">
							...
							<h3 style="text-transform: capitalize;"><a href="blog_page_user.php?id=<?php echo $_SESSION['blog_id']?>"><?php echo $_SESSION['blog_title'];?></a></h3>
							<!-- blog information -->
							<span class="meta">
                            <?php echo $_SESSION['blog_datetime'];?> | Tag: <a style="text-transform: capitalize;"  href="s-cat-user.php?category=<?php echo $row['blog_category']; ?>"> <?php echo $_SESSION['blog_category'];?> </a>| By: <?php echo $_SESSION['blog_author'];?>
							</span>
							<!-- paragraph -->
				...
				<center>
				<span class="input-group-btn">
					<a href="u-morerecent.php"><button class="btn btn-default" type="button">See More</button></a>
				</span>
				</center>
		</div>
