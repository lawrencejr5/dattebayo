...
$stmt3 = $conn -> prepare("SELECT * FROM blog_table ORDER BY blog_id DESC");
$stmt3 -> execute();
        ...
        <div class="blog" id="blog">
			<div class="container">
				<div class="default-heading">
					<!-- heading -->
					<h1 style="text-transform: capitalize;">SUPER ADMIN</h1>
					<h2>Manage All Posts</h2>
				</div>
                <?php  if($stmt3 -> rowcount()===0){?>
                    <div class="post-preview">
                       <h1>NO ONE HAS POSTED YET</h1>
                       <h1><a href="blog_post.php">SIR, BE THE FIRST TO BOST ON YOUR BLOG</a></h1>
                    </div>
                <hr>
				...
				<?php }else{
					...
					<div class="col-md-6 col-sm-6">
						...
						<div class="entry">
                            ...
                            <a href="s-editpost.php?id=<?php echo $row['blog_id']?>"><button style="background: blue;" >Edit</button></a>
