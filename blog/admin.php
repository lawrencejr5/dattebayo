...
<body>
	...
	<div class="wrapper">
		...
		<div class="event" id="event">
			<div class="container">
				...
				<span class="input-group-btn">
					<a href="moreup.php"><button class="btn btn-default" type="button">See More</button></a>
				</span>
				</center>
			</div>
			<hr>
        ...
        <br><br>
				<center>
				<span class="input-group-btn">
					<a href="morerecent.php"><button class="btn btn-default" type="button">See More</button></a>
				</span>
				</center>
		<!-- blog end -->
